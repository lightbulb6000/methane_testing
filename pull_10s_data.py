...
# Output CSV file
output_csv = "methane_10s_data.csv"
...
def process_file(filepath, base_datetime):
    """Processes a single file and extracts methane input and output data every 10 seconds."""
    with open(filepath, "r") as file:
        for i, line in enumerate(file):
            if i % 10 == 0:  # Only process every 10th line
                line = line.strip()
